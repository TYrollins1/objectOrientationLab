...
const totalPopulation = (obj) => {
  ...
  let {utah: noUtah, california: notCalifornia, texas: notTexas, arizona: notArizona} = obj
  return noUtah + notCalifornia + notTexas + notArizona
}
...
let wizard1 = new Wizard('sky', 12, 'rain')
...
let phone1 = new Phone('Apple', '14', 20, 'blue', 380)
let phone2 = new Phone('Apple', '13', 10, 'pink', 470)
let phone3 = new Phone('Apple', '18', 36, 'gold', 1100)
